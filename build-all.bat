...
call nwb nwbuild  -v 0.17.4 --with-ffmpeg -p win32,win64,osx64,linux64 -o C:\tmp\mc-mvp3 --side-by-side

robocopy C:\tmp\mc-mvp3\dependencies\win64 C:\tmp\mc-mvp3\Musicoin-client-win-x64\bin /S
robocopy C:\tmp\mc-mvp3\dependencies\win32 C:\tmp\mc-mvp3\Musicoin-client-win-ia32\bin /S
...
del C:\tmp\mc-mvp3\Musicoin-client-win-ia32\config\config.ext.js
...
del C:\tmp\mc-mvp3\Musicoin-client-win-ia32\build-all.bat
...
RD /S /Q C:\tmp\mc-mvp3\Musicoin-client-win-ia32\.git
...
RD /S /Q C:\tmp\mc-mvp3\Musicoin-client-win-ia32\.idea
...
del C:\tmp\mc-mvp3\Musicoin-client-win-ia32\linux-setup.sh
